...
var benchTupleSys = (function () {
    ...
    benchTupleSys.prototype.createFactories = function () {
        this.vec2Factory = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
        this.easingFactories = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
        this.tupleFactory = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
    };
