...
var benchTupleSys = (function () {
    ...
    benchTupleSys.prototype.createFactories = function () {
        this.vec2Factory = new ComponentFactoryMap_1.ComponentFactoryMap();
        this.easingFactories = new ComponentFactoryMap_1.ComponentFactoryMap();
        this.tupleFactory = new ComponentFactoryMap_1.ComponentFactoryMap();
    };
