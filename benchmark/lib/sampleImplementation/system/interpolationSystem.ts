...
interface IEasingSystem extends ISystem {
    process(factory: IComponentFactory<InterpolableComponent>, progress: number);
...
class InterpolationSystem implements ISytemManager {
    ...
    process(factories: IComponentFactory<InterpolableComponent>[], progress: number) {
