...
var EasingSystem = (function () {
    ...
    EasingSystem.prototype.process = function (factory, ids, progress) {
        var l = ids.length;
        for (var i_1 = 0; i_1 < l; ++i_1) {
            var c = factory.getComponent(ids[i_1]);
...
var linearSys = (function (_super) {
    ...
    linearSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInQuadSys = (function (_super) {
    ...
    easeInQuadSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeOutQuadSys = (function (_super) {
    ...
    easeOutQuadSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInOutQuadSys = (function (_super) {
    ...
    easeInOutQuadSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInCubicSys = (function (_super) {
    ...
    easeInCubicSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeOutCubicSys = (function (_super) {
    ...
    easeOutCubicSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInOutCubicSys = (function (_super) {
    ...
    easeInOutCubicSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInQuartSys = (function (_super) {
    ...
    easeInQuartSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInOutQuartSys = (function (_super) {
    ...
    easeInOutQuartSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeOutQuartSys = (function (_super) {
    ...
    easeOutQuartSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInQuintSys = (function (_super) {
    ...
    easeInQuintSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeOutQuintSys = (function (_super) {
    ...
    easeOutQuintSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var easeInOutQuintSys = (function (_super) {
    ...
    easeInOutQuintSys.prototype.process = function (factory, ids, progress) {
        _super.prototype.process.call(this, factory, ids, progress);
    };
...
var InterpolationSystem = (function () {
    ...
    InterpolationSystem.prototype.process = function (factories, ids, progress) {
        ...
        for (var i_2 = 0; i_2 < l; ++i_2) {
            this.systems[i_2].process(factories[i_2], ids, progress);
        }
    };
