...
// can we use pointer to component instead of id ?
// if we delete a component, we should remove the tuple that use it
// or handle case were one component doesn't exist anymore
...
class TupleComponent implements ITupleComponent {
    constructor(public entityId:string, public tuple:string[]){}
}
