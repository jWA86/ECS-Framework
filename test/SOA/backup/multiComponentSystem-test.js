...
describe("MultiComponentSystem ", function () {
    ...
    var TupleComponent = (function () {
        function TupleComponent(entityId, tuple) {
            this.entityId = entityId;
            this.tuple = tuple;
        }
    ...
    var mCSystem;
    beforeEach(function () {
        var simpleFactory1 = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
        var simpleFactory2 = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
        var simpleFactory3 = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
        factories = [];
    ...
    it("should be able to query components by ids in the proper factory ", function () {
        var tuples = new ComponentFactoryFastMap_1.ComponentFactoryFastMap();
        ...
        chai_1.expect(result[0].entityId).to.equal(components1[0].id);
        chai_1.expect(result[1].entityId).to.equal(components2[0].id);
        chai_1.expect(result[2].entityId).to.equal(components3[0].id);
    });
