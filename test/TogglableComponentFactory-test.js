...
describe("TogglableComponent Factory ", function () {
    ...
    var simpleFactory = new ComponentFactory_1.TogglableComponentFactory(5, multiPropComponent);
    var multiPropFactory = new ComponentFactory_1.TogglableComponentFactory(5, multiPropComponent, "default string", "default string", { x: 0.0, y: 0.0 });
    beforeEach(function () {
        multiPropFactory = new ComponentFactory_1.TogglableComponentFactory(5, multiPropComponent, "default string", "default string", { x: 0.0, y: 0.0 });
        simpleFactory = new ComponentFactory_1.TogglableComponentFactory(5, multiPropComponent);
    });
    it("should be able to retrieve a component by entity id", function () {
        var c = simpleFactory.createComponent(multiPropComponent, "1", true);
        var c2 = simpleFactory.createComponent(multiPropComponent, "2", true);
    ...
    it("should be able to insert a component after another one in pool", function () {
        var t = simpleFactory.createComponent(concreteComponent, "1", true);
        var t2 = simpleFactory.createComponent(concreteComponent, "2", true);
        var t3 = simpleFactory.createComponent(concreteComponent, "3", true);
    ...
    it("should be able to create components with various number of arguments", function () {
        var mc = multiPropFactory.createComponent(multiPropComponent, "c1", true, "p1", 2, { "x": 1, "y": 3 });
    ...
    it("creating 2 components with the same entity Id should create only one component ", function () {
        ...
        var c = multiPropFactory.createComponent(multiPropComponent, "1", false, "p1", 2, { "x": 0.0, "y": 0.0 });
        chai_1.expect(c.entityId).to.not.be.null;
        chai_1.expect(multiPropFactory.values[0].entityId).to.equal(c.entityId);
        var c2 = multiPropFactory.createComponent(multiPropComponent, "1", false, "p2", 3, { "x": 1.0, "y": 1.0 });
    ...
    it("should zeroed the component when we 'remove' ", function () {
        ...
        chai_1.expect(multiPropFactory.removeComponent('1')).to.equal(true);
    ...
    it("should be able to create components with an active proprety and other proreties", function () {
        var mcFactory = new ComponentFactory_1.TogglableComponentFactory(2, multiPropComponent, "default string", "default string", { x: 0.0, y: 0.0 });
        var mc = mcFactory.createComponent(multiPropComponent, "c1", true, "p1", 2, { "x": 1.0, "y": 3.0 });
        ...
        chai_1.expect(mc.prop3.x).to.equal(1);
        chai_1.expect(mc.prop3.y).to.equal(3);
        var mc2 = mcFactory.createComponent(multiPropComponent, "c1", false, "p1", 2, { "x": 1.0, "y": 3.0 });
